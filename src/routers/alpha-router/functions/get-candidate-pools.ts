...
const baseTokensByChain: { [chainId in ChainId]?: Token[] } = {
	...
	[ChainId.WORLDCHAIN]: [WRAPPED_NATIVE_CURRENCY[ChainId.WORLDCHAIN]!],
	[ChainId.BOB]: [USDC_BOB, USDT_BOB, WETH_BOB, WBTC_BOB, SOLVBTC_BOB],
	[ChainId.LISK]: [USDT_LISK, WETH_LISK],
	[ChainId.TAIKO]: [USDC_TAIKO, WETH_TAIKO],
	[ChainId.SEI]: [USDC_SEI, WSEI_SEI],
	[ChainId.MANTLE]: [USDC_MANTLE, USDT_MANTLE, WETH_MANTLE],
	...
	[ChainId.CORN]: [USDC_CORN, USDT_CORN],
	[ChainId.ETHERLINK]: [
		USDC_ETHERLINK,
		USDT_ETHERLINK,
		WETH_ETHERLINK,
