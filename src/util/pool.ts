...
export const V4_ETH_WETH_FAKE_POOL: { [chainId in ChainId]: V4Pool } = {
  ...
  [ChainId.RONIN]: new V4Pool(
    nativeOnChain(ChainId.RONIN),
    nativeOnChain(ChainId.RONIN).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.ZEROG]: new V4Pool(
    nativeOnChain(ChainId.ZEROG),
    nativeOnChain(ChainId.ZEROG).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.GENSYN]: new V4Pool(
    nativeOnChain(ChainId.GENSYN),
    nativeOnChain(ChainId.GENSYN).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.TEMPO]: new V4Pool(
    nativeOnChain(ChainId.TEMPO),
    nativeOnChain(ChainId.TEMPO).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.MEGAETH]: new V4Pool(
    nativeOnChain(ChainId.MEGAETH),
    nativeOnChain(ChainId.MEGAETH).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.ARC]: new V4Pool(
    nativeOnChain(ChainId.ARC),
    nativeOnChain(ChainId.ARC).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.ROBINHOOD]: new V4Pool(
    nativeOnChain(ChainId.ROBINHOOD),
    nativeOnChain(ChainId.ROBINHOOD).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.INK]: new V4Pool(
    nativeOnChain(ChainId.INK),
    nativeOnChain(ChainId.INK).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
